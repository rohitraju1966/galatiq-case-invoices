...
- Make a final decision: approve, reject, or escalate to the auditor (for invoices over $10K).
...
VP_CRITIQUE_SECTION = """This invoice was escalated to auditor review because the total exceeds ${threshold}. A senior auditor has independently verified the facts using tools you did not have access to (audit trail, cumulative spending summaries) and provided this critique.
