...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "review_note", sa.Text(), server_default="Invoice extracted", nullable=False
        ),
        sa.Column("reviewed_by", sa.Text(), server_default="Maker", nullable=False),
        sa.Column("payment_txn_id", sa.Text(), nullable=True),
        sa.Column(
            "updated_at", sa.Date(), server_default="CURRENT_TIMESTAMP", nullable=False
        ),
        sa.PrimaryKeyConstraint("audit_log_id"),
    )
    op.create_table(
        "transaction_invoice_items",
        sa.Column(
            "invoice_transaction_id", sa.Integer(), autoincrement=True, nullable=False
        ),
        sa.Column("trn_id", sa.Integer(), nullable=False),
